...
Hello Rails Back-end is a backend web application that handles the API to display a random greeting message on screen using [Hello React Front-end](https://github.com/adarachel/hello-react-front-end) as front-end
...
Feel free to check the [issues page](https://github.com/adarachel/hello-rails-back-end/issues).
